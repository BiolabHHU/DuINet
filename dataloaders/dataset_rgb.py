...
import torch
from utils import is_png_file, is_bmp_file, load_img, Augment_RGB_torch
...
##################################################################################################
class DataLoaderTrainGT(Dataset):
    def __init__(self, rgb_dir, img_options=None, target_transform=None):
        super(DataLoaderTrainGT, self).__init__()
...
##################################################################################################
class DataLoaderTrainGT0(Dataset):
    def __init__(self, rgb_dir, target_transform=None):
        super(DataLoaderTrainGT0, self).__init__()
...
class DataLoaderValGT(Dataset):
    def __init__(self, rgb_dir, target_transform=None):
        super(DataLoaderValGT, self).__init__()
...
class DataLoaderTestGT(Dataset):
    def __init__(self, rgb_dir, target_transform=None):
        super(DataLoaderTestGT, self).__init__()

        self.target_transform = target_transform

        clean_files = sorted(os.listdir(os.path.join(rgb_dir, 'input')))

        self.clean_filenames = [os.path.join(rgb_dir, 'input', x) for x in clean_files if is_bmp_file(x)]
